...
/**
 * Soleil/lune (issue #245, switch de reglage de theme dans ProfilPage) -
 * meme silhouette que les icones "sun"/"moon" de Feather/Lucide (deja la
 * reference citee pour FunnelIcon ci-dessus), monoline comme le reste de ce
 * fichier plutot qu'un remplissage plein : reste lisible avec `currentColor`
