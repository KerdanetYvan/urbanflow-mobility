...
- [*] [#129](https://github.com/KerdanetYvan/urbanflow-mobility/issues/129) (Dev FE) — Badges de ligne différenciés par mode de transport (bus/tram/métro/train) sur `ItineraryCard`/`CompactPreview` — demande utilisateur en session, hors scope initial de #126/#127, voir `docs/specs/badges-lignes-transport.md`
